...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@mantine/core": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__shell__prebuild___mf_0_mantine_mf_1_core__prebuild__.js");
            return pkg;
        }
      ,
        "@mantine/hooks": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__shell__prebuild___mf_0_mantine_mf_1_hooks__prebuild__.js");
            return pkg;
        }
      ,
        "@tanstack/react-query": async () => {
          let pkg = await import("__mf__virtual/__mfe_internal__shell__prebuild___mf_0_tanstack_mf_1_react_mf_2_query__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
      ...
      const usedRemotes = [
          ...
          ,
                {
                  entryGlobalName: "reactAppRemote",
                  name: "reactAppRemote",
                  type: "module",
          ...
          ,
                {
                  entryGlobalName: "profileVueRemote",
